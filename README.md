...
| [![NGSI LD](https://img.shields.io/badge/NGSI-LD-d6604d.svg)](https://cim.etsi.org/NGSI-LD/official/front-page.html) | :books: [Documentation](https://github.com/FIWARE/tutorials.Roles-Permissions/tree/NGSI-LD) | <img  src="https://cdn.jsdelivr.net/npm/simple-icons@v3/icons/postman.svg" height="15" width="15"> [Postman Collection](https://fiware.github.io/tutorials.Roles-Permissions/ngsi-ld.html) | ![](https://img.shields.io/github/last-commit/fiware/tutorials.Roles-Permissions/NGSI-LD)
| --- | --- | --- | ---
