...
This tutorial explains how to register a client application within Keycloak and how to define and assign roles and
permissions using the Keycloak Authorization Services. It takes the users and groups created in the
[previous tutorial](https://github.com/FIWARE/tutorials.Identity-Management/tree/NGSI-LD) and ensures that only
...
-   [What is Authorization?](#what-is-authorization)
    -   [Standard Concepts of Authorization in Keycloak](#standard-concepts-of-authorization-in-keycloak)
...
-   [Start Up](#start-up)
    ...
    -   [Logging In via REST API](#logging-in-via-rest-api)
        -   [Obtain an Admin Token](#obtain-an-admin-token)
-   [Managing Clients](#managing-clients)
    -   [Client CRUD Actions](#client-crud-actions)
        -   [Create a Client](#create-a-client)
        -   [Read Client Details](#read-client-details)
        -   [List all Clients](#list-all-clients)
        -   [Update a Client](#update-a-client)
        -   [Delete a Client](#delete-a-client)
-   [Managing Realm Roles](#managing-realm-roles)
...
-   [Authorizing Application Access](#authorizing-application-access)
    -   [Authorizing Groups](#authorizing-groups)
        -   [Assign a Role to a Group](#assign-a-role-to-a-group)
        -   [List Roles of a Group](#list-roles-of-a-group)
        -   [Revoke a Role from a Group](#revoke-a-role-from-a-group)
    -   [Authorizing Individual Users](#authorizing-individual-users)
        -   [Assign a Role to a User](#assign-a-role-to-a-user)
        -   [List Roles of a User](#list-roles-of-a-user)
...
[Identity Management](https://github.com/FIWARE/tutorials.Identity-Management/tree/NGSI-LD) tutorial: Keycloak backed by
